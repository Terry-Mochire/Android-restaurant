...
import com.example.android_restaurant.adapters.FirebaseRestaurantViewHolder;
...
public class SavedRestaurantListActivity extends AppCompatActivity {
    ...
    private void setUpFirebaseAdapter() {
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Business, FirebaseRestaurantViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull FirebaseRestaurantViewHolder holder, int position, @NonNull Business model) {
