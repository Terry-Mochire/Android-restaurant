package com.example.android_restaurant.adapters;
...
import com.example.android_restaurant.ui.RestaurantDetailActivity;
...
public class FirebaseRestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void bindRestaurant(Business restaurant) {
        ...
        TextView nameTextView = (TextView) mView.findViewById(R.id.categoryTextView);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                    restaurants.add(snapshot1.getValue(Business.class));
                }
